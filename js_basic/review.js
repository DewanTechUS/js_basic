...
let myVariable = "Hello World"; // This declares a variable named 'myVariable' and initializes it with the string value "Hello World"
...
let anotherVariable = "The value is: " + myVariable;
...
console.log(sabrina.charAt(4)); // prints "i"

const teddy = "Teddy";
// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy
// Unicode is a standard that assigns unique numbers to characters from all writing systems
console.log(teddy.charCodeAt(2)); // prints Unicode value of "d"

// Using fromCharCode() - make it readable for us :). You'll see!
console.log(String.fromCharCode(100)); // prints "d"

// Take your first and last name and concat()
const firstName = "John";
const lastName = "Doe";
console.log(firstName.concat(" ", lastName)); // prints "John Doe"

// Create a string and make it return true using startsWith()
const greeting = "Hello World";
console.log(greeting.startsWith("Hello")); // prints true

// Now use any variable with endsWith() and return false
console.log(greeting.endsWith("Universe")); // prints false

// Finish the following sentence. Use includes() and return true.
const ozgur = 'Once upon a time Ozgur looked up at the Moon, ';
console.log(ozgur.includes("Moon")); // prints true
...
console.log(joshHadALittleLambOopsCow.indexOf("cow")); // prints index of first occurrence of "cow"
...
console.log(vanessa.lastIndexOf("Vanessa")); // prints index of last occurrence of "Vanessa"

// Can we use length for strings? I don't know, you tell me.
const noWeCantTeo = "but did you try it out though?";
console.log(noWeCantTeo.length); // prints the length of the string
...
console.log(replaceGokuWithVegeta.replace("Goku", "Vegeta")); // replaces first occurrence of "Goku" with "Vegeta"

// Josh has been forgetful lately. Let's help Josh by using search(), and find their right 'wifey'. 
const joshIsLookingForWifey = "WIFEY 1, wifey 2, WiFeY 3, Wifey 4";
console.log(joshIsLookingForWifey.search(/wifey/i)); // searches for "wifey" case-insensitive

// I guess we can share this pizza sentence. Use slice() to return the other half of pizza.
const pizzaSentence = "pizza, other half of pizza";
console.log(pizzaSentence.slice(7)); // prints "other half of pizza"

// Now using the pizza sentence, return only pizza (before the comma)
console.log(pizzaSentence.slice(0, 5)); // prints "pizza"
...
console.log(splitTheBill.split(", ")); // splits by comma and space
...
console.log(splitTheBill.split("")); // splits into individual characters

// Use this toLowerCase()
const angry = "LOWER YOUR VOICE DOWN IF YOU AIN'T PAYING MY BILLS.";
console.log(angry.toLowerCase()); // converts to lowercase

// Tuan was angry today. Create a string with words that Tuan would yell out. Now lowercase it, to tell Tuan to chill out. 
const tuanYelling = "I'M SO FRUSTRATED WITH THIS CODE!";
console.log(tuanYelling.toLowerCase()); // tells Tuan to chill out

// toUpperCase()
const jahlunSaidToPutSomeRespectToHisName = "jahlun";
console.log(jahlunSaidToPutSomeRespectToHisName.toUpperCase()); // prints "JAHLUN"
...
console.log(basicGreeting.substring(1, 4)); // prints "ell"

// Returns "JavaScript"
const ohReally = "JavaScript Substring";
console.log(ohReally.substring(0, 10)); // prints "JavaScript"

// Returns aol.com
const aslDays = "xXteoWuzHereXx@aol.com";
console.log(aslDays.substring(15)); // prints "aol.com"

// trim()
// If only I can use this for my love handles...
// Create a variable with a string value with some extra loving on both sides.
const extraLove = "   I love coding!   ";
console.log(extraLove.trim()); // removes whitespace from both sides
